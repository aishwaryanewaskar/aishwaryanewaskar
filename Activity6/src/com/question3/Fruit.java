...
public class Fruit {
	...
	public static void main(String[] args) {
		...
		//adding fruits into the basket list1
			...
			Fruitbasket1.add("Cherry");
			Fruitbasket1.add("Orange");
			Fruitbasket1.add("Grape");
		...
		ArrayList<String> Fruitbasket2=new ArrayList<>();
			...
			Fruitbasket2.add("Jackfruit");
			Fruitbasket2.add("Grape");
		...
		//sorting the 1st list in ascending order
